...
class TrainConfig(NamedTuple):
    ...
    """
    #: train data 파일 경로
    train_path: str = "./dataset/nlu_tasks/pc/pc_train.tsv"
    #: test data 파일 경로
    dev_path: str = "./dataset/nlu_tasks/pc/pc_dev.tsv"
    #: test data 파일 경로
    test_path: str = "./dataset/nlu_tasks/pc/pc_test.tsv"
    #: output dir
    log_dir: str = "./run_outputs/{}/pc/logs"
    summary_dir: str = "./run_outputs/{}/pc/summaries"
    # checkpoint_dir: str = "./run_outputs/{}/pc/checkpoints"
