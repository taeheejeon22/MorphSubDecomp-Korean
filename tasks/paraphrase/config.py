...
class TrainConfig(NamedTuple):
    ...
    """
    #: train data 파일 경로
    train_path: str = "./dataset/nlu_tasks/paraphrase/paraphrase_train.tsv"
    #: test data 파일 경로
    dev_path: str = "./dataset/nlu_tasks/paraphrase/paraphrase_dev.tsv"
    #: test data 파일 경로
    test_path: str = "./dataset/nlu_tasks/paraphrase/paraphrase_test.tsv"
    #: output dir
    log_dir: str = "./run_outputs/{}/paraphrase/logs"
    summary_dir: str = "./run_outputs/{}/paraphrase/summaries"
    # checkpoint_dir: str = "./run_outputs/{}/paraphrase/checkpoints"
