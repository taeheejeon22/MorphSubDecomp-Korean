        ...
        for epoch in range(self.config.num_epochs):
            ...
            for step, data in enumerate(tqdm(self.train_data_loader)):
                ...
                if (step + 1) % self.config.logging_interval == 0:
                    ...
                    self.summary_writer.add_scalar("paraphrase/train/loss", train_loss, self.global_step)
                    self.summary_writer.add_scalar("paraphrase/train/accuracy", train_acc, self.global_step)
            ...
            self.summary_writer.add_scalar("paraphrase/dev/loss", dev_loss, self.global_step)
            self.summary_writer.add_scalar("paraphrase/dev/accuracy", dev_acc, self.global_step)
            ...
            self.summary_writer.add_scalar("paraphrase/test/loss", test_loss, self.global_step)
            self.summary_writer.add_scalar("paraphrase/test/accuracy", test_acc, self.global_step)
