...
from tasks.cb.data_utils import load_data
from tasks.cb.dataset import CBDataset
from tasks.cb.model import CBModel
from tasks.cb.trainer import Trainer
...
def main(args):
    ...
    model = CBModel(bert_config, config.dropout_prob)
