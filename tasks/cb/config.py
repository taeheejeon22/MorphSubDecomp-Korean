...
class TrainConfig(NamedTuple):
    ...
    """
    #: training data 파일 경로
    train_path: str = "./dataset/nlu_tasks/cb/NIKL_CB_2020_train.csv"
    #: dev data 파일 경로
    dev_path: str = "./dataset/nlu_tasks/cb/NIKL_CB_2020_val.csv"
    #: test data 파일 경로
    test_path: str = "./dataset/nlu_tasks/cb/NIKL_CB_2020_val.csv"
    #: output dir
    log_dir: str = "./run_outputs/{}/cb/logs"
    summary_dir: str = "./run_outputs/{}/cb/summaries"
    # checkpoint_dir: str = "./run_outputs/{}/cb/checkpoints"
