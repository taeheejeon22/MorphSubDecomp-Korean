...
class TrainConfig(NamedTuple):
    ...
    """
    #: training data 파일 경로
    train_path: str = "./dataset/nlu_tasks/klue-re-v1.1/klue-re-v1.1_train.json"
    #: dev data 파일 경로
    dev_path: str = "./dataset/nlu_tasks/klue-re-v1.1/xnli.dev.ko.tsv"
    #: test data 파일 경로
    test_path: str = "./dataset/nlu_tasks/klue-re-v1.1/xnli.test.ko.tsv"
    #: output dir
