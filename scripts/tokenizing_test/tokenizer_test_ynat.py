...
ynat_test = load_data('tokenized_result/ynat.tsv')
# dp_test = pd.read_csv('tokenized_result/dp.tsv')

with open('tokenized_result/ynat_test.csv', "w", encoding='utf-8') as f:
    show_tokenizations("뱌뵵뵤벼벼벼추퓨를 먹었다.")
    for sent1 in (ynat_test):
