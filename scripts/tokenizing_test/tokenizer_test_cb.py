...
cb_test = load_data('dataset/nlu_tasks/cb/NIKL_CB_2020_val.csv')

with open('tokenized_result/cb_test.csv', "w", encoding='utf-8') as f:
    show_tokenizations("뱌뵵뵤벼벼벼추퓨를 먹었다.")
    for sent1, sent2 in zip(cb_test[0], cb_test[1]):
