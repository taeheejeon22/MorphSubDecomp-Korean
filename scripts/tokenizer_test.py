...
paws_test = load_data('dataset/nlu_tasks/paws/test_2k.tsv')

with open('tokenized_result/paws_test.csv', "w", encoding='utf-8') as f:
    show_tokenizations("뱌뵵뵤벼벼벼추퓨를 먹었다.")
    for sent1, sent2 in zip(paws_test[0], paws_test[1]):
