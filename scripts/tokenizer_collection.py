...
class tokenizers():
    ...
    def mecab_tokenizer(self, sent: str, token_type: str, tokenizer_type: str, decomposition_type: str, flatten: bool = True, lexical_grammatical: bool = False):
        ...
        # morpheme tokenization
            ...
            if decomposition_type == "composed":
                mecab_tokenized = self.mecab_composed_decomposed_simple(sent=sent, lexical_grammatical=lexical_grammatical, use_original=use_original, pure_decomposition=False, nfd=self.nfd, flatten=flatten)

            elif decomposition_type == "decomposed_simple":
                mecab_tokenized = self.mecab_composed_decomposed_simple(sent=sent, lexical_grammatical=lexical_grammatical, use_original=use_original, pure_decomposition=True, nfd=self.nfd, flatten=flatten)
...
# ee = tok.mecab_tokenizer(sent, token_type="eojeol", tokenizer_type="none", decomposition_type="decomposed_simple"); print(ee)
...
# ee = tok.mecab_tokenizer(sent, token_type="morpheme", tokenizer_type="mecab_orig", decomposition_type="decomposed_simple", flatten=True); print(ee)
# ee = tok.mecab_tokenizer(sent, token_type="morpheme", tokenizer_type="mecab_orig", decomposition_type="decomposed_simple", flatten=False); print(ee)
...
# ee = tok.mecab_tokenizer(sent, token_type="morpheme", tokenizer_type="mecab_fixed", decomposition_type="decomposed_simple"); print(ee)
# ee = tok.mecab_tokenizer(sent, token_type="morpheme", tokenizer_type="mecab_fixed", decomposition_type="decomposed_simple", flatten=False); print(ee)
...
# ee = tok.mecab_tokenizer(sent, token_type="morpheme", tokenizer_type="mecab_fixed", decomposition_type="decomposed_simple", lexical_grammatical=True); print(ee)
# ee = tok.mecab_tokenizer(sent, token_type="morpheme", tokenizer_type="mecab_fixed", decomposition_type="decomposed_simple", lexical_grammatical=True, flatten=False); print(ee)
...
# ee = tok.mecab_tokenizer(sent, tokenizer_type="mecab_orig", decomposition_type="decomposed_simple_nfd") # ['넌', '▃', '날', '▃', '좋', '아', '해']
#
# ee = tok.mecab_tokenizer(sent, tokenizer_type="mecab_fixed", decomposition_type="decomposed_morphological_nfd") # ['넌', '▃', '날', '▃', '좋', '아', '해']
#
# ee = tok.mecab_tokenizer(sent, tokenizer_type="mecab_fixed", decomposition_type="decomposed_simple_nfd") # ['넌', '▃', '날', '▃', '좋', '아', '해']
#
# len(ee[0])
# len(ee[1])
# len(ee[2])
