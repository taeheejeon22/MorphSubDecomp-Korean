...
def preprocessed_corpus_tokenizer(text: str, token_type: str, tokenizer_type: str, decomposition_type: str,  space_symbol: str = "▃", dummy_letter: str = "", flatten: bool = True, lexical_grammatical: bool = False) -> List[str]:
    text = text.strip()
