...
import scripts.tokenizers_acl_v3_2_BTS as Tokenizers
...
def tokenize_our(text: str, token_type: str, tokenizer_type: str, decomposition_type: str,  space_symbol: str = "▃", dummy_letter: str = "", flatten: bool = True, lexical_grammatical: bool = False, BTS: bool = False) -> List[str]:
    text = text.strip()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--BTS", action="store_true", default=False)  # NFD 사용해서 자모 분해할지
    ...
    tok = Tokenizers.tokenizers(dummy_letter=args["dummy_letter"], space_symbol=args["space_symbol"], grammatical_symbol=[symbol_josa, symbol_eomi], nfd=args["nfd"], BTS=args["BTS"])
