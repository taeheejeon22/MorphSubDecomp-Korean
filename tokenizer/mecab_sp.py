...
class MeCabSentencePieceTokenizer(BaseTokenizer):
    def __init__(self, mecab: MeCabTokenizer, sp: SentencePieceTokenizer):
        ...
        # self.mecab = MeCabTokenizer(config_path="./resources/v2_with_dummy_letter/wikiko_all_64k/mecab_orig_composed_sp-64k/tok.json")
        # self.sp = SentencePieceTokenizer(model_path="./resources/v2_with_dummy_letter/wikiko_all_64k/mecab_orig_composed_sp-64k/tok.model")
        # self.mecab = MeCabTokenizer(config_path="./resources/v2_with_dummy_letter/wikiko_all_64k/mecab_fixed_composed_sp-64k/tok.json")
        # self.sp = SentencePieceTokenizer(model_path="./resources/v2_with_dummy_letter/wikiko_all_64k/mecab_fixed_composed_sp-64k/tok.model")
